...
public class PdfGenerator {
	...
	public void generatePdf(List<SearchResponse> records, HttpServletResponse response)
		...
		Font font = new Font(Font.HELVETICA, 16, Font.BOLDITALIC, Color.GREEN);
		Paragraph para = new Paragraph("Elegibility Details ", font);
		...
		for (SearchResponse record : records) {
			...
			table.addCell(String.valueOf(record.getBenefirAmt()));
